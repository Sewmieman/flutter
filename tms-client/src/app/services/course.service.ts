...
export class CourseService {
    ...
    private baseUrl = "http://localhost:5085/api/v1/courses";
    getAll(page = 1, pageSize = 50) {
        // This URL is GET /api/courses → map items[] (M6 catalogue envelope). Never accept a bare root [...].// Switch to map((p) => p.data) 
        // if your base URL is GET /api/v2/courses; paging often nests under meta on that envelope (Step 1).
        return this.http
